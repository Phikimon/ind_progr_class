...
// Returns sum of hex digits of val
...
// Returns if val is divisible by 5
...
// Returns difference between digits at odd and even places of val
...
// Returns if val is divisible by 3
